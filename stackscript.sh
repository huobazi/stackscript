...
wget https://raw.githubusercontent.com/huobazi/stackscript/master/shadowsocks.json -O /etc/shadowsocks.json
wget https://raw.githubusercontent.com/huobazi/stackscript/master/shadowsocks.conf -O /etc/supervisor/conf.d/shadowsocks.conf
wget https://raw.githubusercontent.com/huobazi/stackscript/master/local.conf -O /etc/sysctl.d/local.conf
